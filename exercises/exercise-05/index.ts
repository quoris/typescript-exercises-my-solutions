...
//function filterPersons(persons: Person[], personType: string, criteria: PartialPerson): User[];
//function filterPersons(persons: Person[], personType: string, criteria: PartialPerson): Admin[];
function filterPersons(persons: Person[], personType: string, criteria: PartialPerson): any[] {
    return persons
