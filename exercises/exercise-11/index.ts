/// <reference path="declarations/stats/index.d.ts"/>
...
console.log(` - was ${colorizeIndex(getMinIndex(admins, compareAdmins))}th to register`);

console.log();

console.log(chalk.yellow('Median admin:'));
logAdmin(getMedianElement(admins, compareAdmins));
console.log(` - was ${colorizeIndex(getMedianIndex(admins, compareAdmins))}th to register`);

console.log();

console.log(chalk.yellow('Oldest admin:'));
logAdmin(getMaxElement(admins, compareAdmins));
console.log(` - was ${colorizeIndex(getMaxIndex(admins, compareAdmins))}th to register`);
